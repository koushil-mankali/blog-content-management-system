                ...
                <?php
                    ...
                    if($respg->num_rows()>0){
                        ...
                        if($ttlrecords>10){
                            ...
                            if($pageno>1){
                                echo '<li class="paginationli prev"><a href="search.php?search='.$searcht.'&page='.($pageno-1).'">Prev</a></li>';
                            }else{
                                $pageno=1;
                                echo '<li class="paginationli prev"><a href="search.php?search='.$searcht.'&page='.($pageno).'">Prev</a></li>';
                            }
                            for($i=1;$i<=$ttlpages;$i++){
                                ...
                                echo '<li class="paginationli '.$pgactive.'"><a href="search.php?search='.$searcht.'&page='.$i.'">'.$i.'</a></li>';
                            }
                            if($pageno<$ttlpages){
                                echo '<li class="paginationli next"><a href="search.php?search='.$searcht.'&page='.($pageno+1).'">Next</a></li>';
                            }else{
                                $pageno=$ttlpages;
                                echo '<li class="paginationli prev"><a href="search.php?search='.$searcht.'&page='.($pageno).'">Next</a></li>';
                            }
                            echo '</ul>';
                        }
                    }
