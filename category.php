    ...
    <div class="container my-3">
        <div class="row">
            ...
            <?php 
                    ...
                    $sql="SELECT post_id,post_name,post_desc,post_date,post_img,ur.id,ur.uname,ct.category_id,ct.category_name FROM posts LEFT JOIN users ur ON posts.author=ur.id LEFT JOIN category ct ON posts.category=ct.category_id WHERE category_id=$catpage LIMIT $offsetl,$limit";
                ...
                <div class="post">
                    <span class="postimg">
                           <img src="<?php if(isset($pimg)){echo "admin/images/".$pimg;} ?>" alt="">
                    </span>
